...
{
    public class CompletionQualityPlugin : Slb.Ocean.Core.Plugin
    {
        ...
        public override IEnumerable<ModuleReference> Modules
        {
            get 
            {
                yield return new ModuleReference(typeof(CompletionQualityCubes.CompletionQualityCubesModule)); 
                yield return new ModuleReference(typeof(CompletionQualityCubes.Module)); 
        ...
        {
            get { return "CompletionQualityPlugin"; }
        }
