...
{
    public class COEGeomechanicsPlugin : Slb.Ocean.Core.Plugin
    {
        ...
        public override IEnumerable<ModuleReference> Modules
        {
            get 
            {
                yield return new ModuleReference(typeof(COEGeomechanicsModule1)); 
        ...
        {
            get { return "COEGeomechanicsPlugin"; }
        }
