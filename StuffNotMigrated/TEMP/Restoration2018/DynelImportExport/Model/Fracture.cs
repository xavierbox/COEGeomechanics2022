...
namespace Restoration.Model
{
    ...
    public class FractureModel
    {
        ...
        public List<Fracture> Fractures { get { return Fracs; } set { Fracs = value; } }

        public List<Fracture> Fracs { get => _fracs; set => _fracs = value; }
