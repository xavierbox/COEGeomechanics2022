...
namespace OceanControls
{
    ...
    public partial class DropPresentationBox : UserControl
    {
        ...
        public Object Value
        {
            ...
            set
            {
                ...
                else //(AcceptedTypes == null) //use default 
                {
                    ...
                    else if (value is SeismicLine3D)
                    {
                        SeismicLine3D s1 = (SeismicLine3D)(value);
                        dropTarget1.Tag = s1;
                        presentationBox1.Text = s1.Name;
                        _value = s1;
                        presentationBox1.Image = PetrelImages.Seismic3D;
                    ...
                    {
                        SeismicCollection s1 = (SeismicCollection)(value);
                        dropTarget1.Tag = s1;
                        presentationBox1.Text = s1.Name;
                        _value = s1;
                    ...
                    {
                        PropertyCollection s1 = (PropertyCollection)(value);
                        dropTarget1.Tag = s1;
                        presentationBox1.Text = s1.Name;
                        _value = s1;
                        presentationBox1.Image = PetrelImages.Property;
                        setStyleTextBox();
                        DataDropAccepted?.Invoke(this, new EventArgs());
                    }
        ...
        private void setStyleTextBox()
        {
            ...
            else if ((_value.GetType() == typeof(float)) || (_value.GetType() == typeof(double)) || (_value.GetType() == typeof(int)))
            {
