...
{
    /// <summary>
    /// Summary description for WindowTest.
    /// </summary>
    class WindowTest : ToggleWindow, IImageInfoSource, INameInfoSource
    {
        public WindowTest()
        {
            //
        ...
        {
            get { return new WindowTestImageInfo(); }
        }
        ...
        {
            get { return new WindowTestNameInfo(this); }
        }
