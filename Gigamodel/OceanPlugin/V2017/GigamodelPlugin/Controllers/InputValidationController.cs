    ...
    internal class InputValidationController
    {
        ...
        private void Connect()
        {
            ...
            ui.materialsControl.DeleteModelEvent += (s, e) => 
            {
                ...
                /*
                model.MaterialModels.Clear();
                model.PressureModels.Clear();
                model.BoundaryConditionsModels.Clear();
                ...
                ui.materialsControl.IsSelectedAsNew = true;
                ui.pressuresControl.IsSelectedAsNew = true;
